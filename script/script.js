...
function validarRegistro() {
  ...
  let nombre_apellidos = document.getElementById("nombre_apellidos");
  let email = document.getElementById("email_registro");
  let contraseña = document.getElementById("contrasena_registro");
  ...
  if (!regexNombreApellidos.test(nombre_apellidos.value)) {
